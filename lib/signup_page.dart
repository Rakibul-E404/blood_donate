...
//   String selectedBloodGroup = 'Select your blood group'; // Initial value
//   String selectedDivision = 'Select your division'; // Initial value
//   String selectDistrict = 'Select your districts'; // Initial value
//   String selectUpazila = 'Select your upazila'; // Initial value
...
//     upazilas.clear();
//     // print(data.keys);
//     for(var division in data.keys){
//       divisions.add(division);
//       // print(division);
//       // print(data["Dhaka"].keys);
//       // for(var district in data[division].keys)
//       // {
//       //   districts.add(district);
//       //   upazilas.addAll(data[division][district].cast<String>());
//       // }
//       // break;
//     }
//     // districts = data.keys;
...
//
//     // print(jsonDecode(data["payload"]["blob"]["rawLines"])[0]['districts']);
//     // final districtsJsonList = data["payload"]["blob"]["rawLines"][0];
//     // print(districtsJsonList);
//     // for (var json in districtsJsonList) {
//     //   districts.add(json['name']);
//     // }
//     setState(() {});
//   }
//
...
//         selectedDivision == 'Select your divisions' ||
//         selectDistrict == 'Select your districts' ||
//         selectUpazila == 'Select your upazilas' ||
...
//                     else{
//                       districts.clear();
//                       if(data[newValue].keys != null || data[newValue].keys.isNotEmpty){
//                         districts.addAll(data[newValue].keys);
//                         // upazilas.addAll(data[newValue][selectDistrict].keys.cast<String>());
//                         // List<String>? upazilas.addAll = data[newValue][selectDistrict];
//                         List<String>? selectupazilas = data[newValue][selectDistrict]?.cast<String>();
//                       }
//
//
//                     }
...
//                 ),
//                 SizedBox(height: 10.0),
//                 districts.isEmpty? Container() : DropdownButtonFormField<String>(
...
//                     );
//                   }).toList(),
//                   decoration: InputDecoration(labelText: 'District Location'),
//                 ),SizedBox(height: 10.0),
//                 upazilas.isEmpty? Container() : DropdownButtonFormField<String>(
//                   value: selectUpazila,
//                   // value: selectedDistrict,
//                   onChanged: (String? newValue) {
//                     setState(() {
...
//                   },
//                   items: [
//                     'Select your upazilas', // Initial text
//                     ...upazilas,
//                   ].map<DropdownMenuItem<String>>((String value) {
//                     return DropdownMenuItem<String>(
//                       value: value,
...
//                     );
//                   }).toList(),
//                   decoration: InputDecoration(labelText: 'Upazila Location'),
//                 ),
//                 SizedBox(height: 10.0),
//                 Row(
//                   children: [
...
//                         // List<String>? upazilas.addAll = data[newValue][selectDistrict];
//                         if(data[newValue].keys != null || data[newValue].keys.isNotEmpty){
//                           List<String>? selectupazila = data[newValue][selectDistrict]?.cast<String>();
//                         }
//                         // List<String>? selectupazilas = data[newValue][selectDistrict]?.cast<String>();
//                       }
//
              ...
              children: [
                ...
                upazilas.isEmpty
                  ...
                  onChanged: (String? newValue) {
                    setState(() {
                      selectUpazila = newValue!;
                      // Clear the previous list of upazilas
                      // upazilas.clear();
                      // Populate the upazilas list with the selected district's upazilas
                      if (data[selectedDivision][selectDistrict] != null) {
